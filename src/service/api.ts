...
export class ApiService {
  ...
  async updateRestaurants( dados : updateRestaurant, id : string | undefined) {
    ...
    const ret = await this.axios.patch(`/restaurants/${id}`, JSON.stringify(dados), customConfig);
    return ret
  }
  ...
  async deleteRestaurants( id : string | undefined, password: any) {
    ...
    const ret = await this.axios.delete(`/restaurants/${id}`, {data: postData}, customConfig);
    console.log(ret)
    return ret
  }
  ...
  async updateTimes( dados : updateTimes, id : string) {
    ...
    const ret = await this.axios.patch(`/times/${id}`, JSON.stringify(dados), customConfig);
    return ret
  }
